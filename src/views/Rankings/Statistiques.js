...
export default function Statistiques() {
  ...
  return (
    <div className="text-center mt-5">
      <div>
        <h2>Statistiques</h2>
        <p>Voici les catégories les plus populaires</p>
      </div>
      <div className="statsContener d-flex flex-wrap w-100">
        <div className="col-lg-7 col-12 d-flex h-100 justify-content-start">
          {isFetching ? (
            ...
            currentData && <Bar options={options} data={parseScoreDataset()} />
          )}
        </div>
        <div className="infosStats col-lg-5 col-12 d-flex flex-column justify-content-center text-start">
          <p>
            *Le pourcentage de Questions/Astuces par catégories est calculé à
            partir du nombre de questions/astuces ayant la catégorie associée.
          </p>
          <p>
            **Tandis que les catégories préférées pour les utilisateurs sont
            basées sur celles renseignées dans le profil.
          </p>
        </div>
      </div>
    </div>
