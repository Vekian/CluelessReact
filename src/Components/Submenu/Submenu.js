...
export default function SubMenu() {
  ...
  function displayMenu(event) {
    ...
    let menu = document.querySelector(".subMenuHeader");
    ...
    <div className=" w-100 overflow-hidden subMenuMain">
      <div className="d-flex flex-column align-items-center subMenuHeaderContainer w-100">
        <div className="subMenuHeader d-flex justify-content-around align-items-center">
          ...
          <Link
            to="/create/question"
            className={location.pathname === "/create/question" ? "active" : ""}
          >
            <i className="fa-solid fa-question"></i>
          </Link>
          <Link
            to="/create/clue"
            className={location.pathname === "/create/clue" ? "active" : ""}
          >
            <i className="fa-regular fa-lightbulb"></i>
          </Link>
          <Link
            to="/helpers"
            className={location.pathname === "/helpers" ? "active" : ""}
          >
        ...
        <span className="containerButtonSubMenuHeader">
          <div
            className="buttonSubMenuHeader text-center"
