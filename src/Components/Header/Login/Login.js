          ...
          <div className="modal-content d-flex align-items-center">
            <div className="modal-header offset-4 col-8">
              <h5 className="modal-title" id="loginModalLabel">
                {isPasswordForgot
                  ? "Mot de passe oublié"
                  : !isSigning && "Connectez vous"}
                {isSigning && "Inscrivez vous"}
              </h5>
            ...
            {isPasswordForgot ? (
              ...
              <div className="modal-body d-flex flex-column align-items-center">
                <h4 className="mb-2">Inscrivez-vous avec google</h4>
                <GoogleLogin
                  loadData={loadData}
                ...
                <h5 className="modal-title" id="loginModalLabel">
                  Se connecter ? C'est par{" "}
                  <u
                    className="linkSigning"
                ...
                >
                  {errors.username?.type === "maxLength" && (
                    <p className="mb-1 text-danger" role="alert">
                      Ne peut dépasser 100 caractères
                    </p>
                  )}
                  ...
                  <input
                    value="Se connecter"
                    type="submit"
                    className="buttonStyle mt-1"
                  />
                </form>
                <h5 className="modal-title" id="loginModalLabel">
                  Pas encore inscrit ? C'est par{" "}
                  <u className="linkSigning" onClick={() => setIsSigning(true)}>
                    ici
                  </u>
                </h5>
                <h5 className="modal-title" id="loginModalLabel">
                  ...
                  <u
                    className="linkSigning"
                    onClick={() => setIsPasswordForgot(true)}
                  >
                    ici
                  </u>
                </h5>
