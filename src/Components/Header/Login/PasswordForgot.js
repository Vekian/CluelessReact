  ...
  return (
    <div className="modal-body d-flex flex-column align-items-center">
      <p className="text-center">
        Indiquez le mail et le pseudo de votre compte. <br />
        Si celui-ci existe, un nouveau mot de passe vous sera envoyé par email.
      </p>
      {isSending ? (
        <Comment
          visible={true}
        ...
        >
          ...
          <br />
          <span className="text-success">{isSent}</span>
          <input value="Envoyer" type="submit" className="buttonStyle mt-3" />
        </form>
      )}
    </div>
  );
