...
export default function Register(props) {
  ...
  return (
    <div className="text-center">
      <h4 className="mb-2">Ou avec votre email</h4>
      <form
      ...
      >
        ...
        {errors.pseudo?.type === "maxLength" && (
          <p className="mb-1 text-danger" role="alert">
            Ne peut dépasser 20 caractères
          </p>
        )}
        {errors.pseudo?.type === "minLength" && (
          <p className="mb-1 text-danger" role="alert">
            Doit posséder au moins 3 caractères
          </p>
        )}
        ...
        <input value="S'inscrire" type="submit" className="buttonStyle mt-3" />
      </form>
    </div>
  );
}
